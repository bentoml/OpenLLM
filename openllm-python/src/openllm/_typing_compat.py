...
class LLMRunnable(bentoml.Runnable, t.Generic[M, T]):
  ...
  generate_iterator: RunnableMethod[LLMRunnable[M, T], [str], t.Generator[str, None, None]]
...
class LLMRunner(bentoml.Runner, t.Generic[M, T]):
  ...
  generate_iterator: RunnerMethod[LLMRunnable[M, T], [str], t.Generator[str, None, None]]
