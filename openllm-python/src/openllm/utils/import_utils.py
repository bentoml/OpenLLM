...
_ctransformers_available = _is_package_available("ctransformers")
...
def is_ctransformers_available() -> bool: return _ctransformers_available
...
BACKENDS_MAPPING: BackendOrderedDict = OrderedDict([("flax", (is_flax_available, FLAX_IMPORT_ERROR)), ("tf", (is_tf_available, TENSORFLOW_IMPORT_ERROR)), ("torch", (is_torch_available, PYTORCH_IMPORT_ERROR)),
                                                    ...
                                                    ("xformers", (is_xformers_available, XFORMERS_IMPORT_ERROR)), ("fairscale", (is_fairscale_available, FAIRSCALE_IMPORT_ERROR)), ("ctransformers", (is_ctransformers_available, CTRANSFORMERS_IMPORT_ERROR))])
