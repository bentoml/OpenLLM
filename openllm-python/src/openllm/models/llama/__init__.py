...
from openllm.utils import LazyModule, is_torch_available, is_vllm_available, is_ctransformers_available
...
try:
  ...
  if t.TYPE_CHECKING: from .modelling_ggml_llama import GGMLLlama as GGMLLlama
