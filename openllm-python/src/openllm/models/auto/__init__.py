...
_import_structure: dict[str, list[str]] = {'modeling_auto': ['MODEL_MAPPING_NAMES'], 'modeling_vllm_auto': ['MODEL_VLLM_MAPPING_NAMES']}
if t.TYPE_CHECKING:
...
try:
  ...
  _import_structure['modeling_vllm_auto'].extend(['AutoVLLM'])
  if t.TYPE_CHECKING:
...
try:
  ...
  _import_structure['modeling_vllm_auto'].extend(['MODEL_VLLM_MAPPING'])
