...
MODEL_VLLM_MAPPING: OrderedDict[t.Type[openllm.LLMConfig], t.Type[openllm.LLM["vllm.LLMEngine", "transformers.PreTrainedTokenizer"]]] = _LazyAutoMapping(CONFIG_MAPPING_NAMES, MODEL_VLLM_MAPPING_NAMES)
