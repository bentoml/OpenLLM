...
MODEL_TF_MAPPING: OrderedDict[t.Type[openllm.LLMConfig], t.Type[openllm.LLM["transformers.TFPreTrainedModel", "transformers.PreTrainedTokenizer"]]] = _LazyAutoMapping(CONFIG_MAPPING_NAMES, MODEL_TF_MAPPING_NAMES)
