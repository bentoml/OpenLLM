...
_import_structure: dict[str, list[str]] = {
  ...
  "utils": ["infer_auto_class"], "serialisation": ["ggml", "transformers"], "cli._sdk": ["start", "start_grpc", "build", "import_model", "list_models"],
  "_llm": ["LLM", "Runner", "LLMRunner", "LLMRunnable", "LLMEmbeddings"],
  "_configuration": ["LLMConfig", "GenerationConfig", "SamplingParams"], "_generation": ["StopSequenceCriteria", "StopOnTokens", "LogitsProcessorList", "StoppingCriteriaList", "prepare_logits_processor"],
  "_quantisation": ["infer_quantisation_config"], "_schema": ["GenerationInput", "GenerationOutput", "MetadataOutput", "EmbeddingsOutput", "unmarshal_vllm_outputs", "HfAgentInput"],
  ...
  "models.chatglm": ["ChatGLMConfig"], "models.baichuan": ["BaichuanConfig"], "models.dolly_v2": ["DollyV2Config"],
  "models.falcon": ["FalconConfig"], "models.flan_t5": ["FlanT5Config"], "models.gpt_neox": ["GPTNeoXConfig"],
  "models.llama": ["LlamaConfig"], "models.mpt": ["MPTConfig"], "models.opt": ["OPTConfig"],
  "models.stablelm": ["StableLMConfig"], "models.starcoder": ["StarCoderConfig"]}
...
try:
  ...
  from openllm.utils import dummy_pt_objects
  _import_structure["utils.dummy_pt_objects"] = dummy_pt_objects.__all__
else:
...
try:
  ...
  from openllm.utils import dummy_vllm_objects
  _import_structure["utils.dummy_vllm_objects"] = dummy_vllm_objects.__all__
else:
...
try:
  ...
  from openllm.utils import dummy_flax_objects
  _import_structure["utils.dummy_flax_objects"] = dummy_flax_objects.__all__
else:
...
try:
  ...
  from openllm.utils import dummy_tf_objects
  _import_structure["utils.dummy_tf_objects"] = dummy_tf_objects.__all__
else:
