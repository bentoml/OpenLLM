...
class _ModelSettingsAttr:
    ...
    if t.TYPE_CHECKING:
        ...
        # the target generation_config class to be used.
        fine_tune_strategies: tuple[dict[str, t.Any], ...]
...
class _ConfigAttr:
    ...
    if t.TYPE_CHECKING:
        ...
        __openllm_name_type__: t.Literal['dasherize', 'lowercase'] = Field(None)
...
class LLMConfig(_ConfigAttr):
    ...
    def __init_subclass__(cls: type[LLMConfig]):
        ...
        name_type = cls.__config__.get("name_type", _ModelSettingsAttr.default().name_type)
